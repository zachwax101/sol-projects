...
contract Airdrop is Ownable {
    ...
    /// @notice A merkle root node used to prove inclusion in a set of airdrop claimer addresses.
    ...
    function toTypedDataHash(address _claimer, uint256 _amount)
        internal
        view
        returns (bytes32)
    {
    ...
    /// `Airdrop.merkleRoot`
    function toLeafFormat(address _claimer, uint256 _amount)
        internal
        pure
        returns (bytes32)
    {
