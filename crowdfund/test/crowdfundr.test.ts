...
describe("Crowdfundr", () => {
  ...
  describe("ProjectFactory", () => {
    it("Can deploy the Factory contract", async () => {
    ...
    it("Can create a single project", async () => {
    ...
    it("Creates projects with the correct creator", async () => {
      expect(true).to.be.false;
    });

    it("Creates projects with a preset funding goal (in units of wei)", async () => {
      expect(true).to.be.false;
    });

    it('Emits a "FILL_ME_IN" event after creating a project', async () => {
      expect(true).to.be.false;
    });

    it("Allows multiple projects to exist and accept ETH contributions independently of each other", async () => {
      expect(true).to.be.false;
    });
  });
